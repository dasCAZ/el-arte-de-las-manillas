document.getElementById("login").addEventListener("submit", function (event) { //Se trabaja en el formulario, y se ejecuta la funcion cuando se da click en el boton
...
//Condicional, si valor del input login es igual al valor del localStorage ejecutar lo siguiente 
    if (usuarioRegistrado.correo === correoLogin && usuarioRegistrado.contrasena === contrasenaLogin) {
        ...
        window.location.href = "principal.html"; //Redirige al html 
    } else {
